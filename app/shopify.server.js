...
//     afterAuth: async ({ session }) => {
//       try {
//         console.log("➡️ Saving Session After Auth...");
//         await shopify.sessionStorage.storeSession(session);

//         console.log("➡️ Registering Webhooks (auto)...");
//         await shopify.registerWebhooks({ session });

//         console.log("➡️ Redirecting to post-auth...");
//         return redirect(
//           `/post-auth?shop=${session.shop}&host=${Buffer.from(session.shop).toString("base64")}`,
//         );
//       } catch (e) {
//         logError("AfterAuth Error", e);
//         throw e;
//       }
//     },
//   },

//   // ░░ LIVE vs STAGING WEBHOOKS ░░
//   webhooks: IS_LIVE
//     ? {
//         // ------- LIVE -------
//         ORDERS_CREATE: {
